        ...
        <xsl:choose>
            ...
            <xsl:when test="n1:text/@mediaType='text/html'">
              <div WIDTH="100%" HEIGHT="66%">
                 <!--xsl:copy-of select="n1:text/cdata()" /-->
                 <!-- xsl:copy-of select="n1:text/text()" disable-output-escaping="true" / -->
                 <!--xsl:value-of select="n1:text/text()" disable-output-escaping="no" / -->
                 <!--xsl:value-of select="n1:text" disable-output-escaping="yes" / -->
                 <!--xsl:value-of select="n1:text" disable-output-escaping="yes" /-->
                 <!--xsl:text disable-output-escaping="yes"></xsl:text -->

                 <!--xsl:value-of select="n1:text" disable-output-escaping="no" /-->
                 <xsl:copy-of select="n1:text/n1:div" />
