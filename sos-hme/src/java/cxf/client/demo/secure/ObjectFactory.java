...
public class ObjectFactory {
    ...
    private final static QName _SecureMethod_QNAME = new QName("http://cda/", "secureMethod");
    private final static QName _SecureMethodResponse_QNAME = new QName("http://cda/", "secureMethodResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cda/", name = "secureMethod")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cda/", name = "secureMethodResponse")
