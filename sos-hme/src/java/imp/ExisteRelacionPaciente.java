...
/**
 * <p>Clase Java para existeRelacionPaciente complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="existeRelacionPaciente">
 *   &lt;complexContent>
...
@XmlType(name = "existeRelacionPaciente", propOrder = {
    "idPacienteOrg",
    "idOrganizacion"
})
public class ExisteRelacionPaciente {
